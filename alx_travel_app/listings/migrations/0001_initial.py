    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('host', 'host'), ('admin', 'admin'), ('guest', 'guest')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Listing', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Confirmed', 'Confirmed'), ('Canceled', 'Canceled')], max_length=25)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
